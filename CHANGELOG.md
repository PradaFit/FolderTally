...
- PDF/UA-1 metadata, embedded fonts, and independent machine validation of representative PDFs.
- Fresh directory containment, reparse, and identity checks around traversal.
